...
@section('content')
    <section class="section-0 lazy d-flex bg-image-style dark align-items-center entered loaded" data-bg="assets/images/banner5.jpg" data-ll-status="loaded" style="background-image: url(&quot;assets/images/banner5.jpg&quot;);">
        <div class="container">
            <div class="row">
